...
class CheatSheetData(TypedDict, total=False):
    """Type definition for a cheat sheet data structure."""
    name: str
    content: str
    categories: list[str]
    description: str
...
class CheatSheetCollection(TypedDict):
    """Type definition for the cheat sheet collection structure."""
    cheatsheets: list[CheatSheetData]

# Configuration
DEFAULT_STORAGE_PATH: str = os.path.expanduser("~/.cheatsheets.json")
DEFAULT_STORAGE_STRUCTURE: CheatSheetCollection = {"cheatsheets": []}
...
class CheatSheetManager:
    ...
    def _load_cheatsheets(self) -> CheatSheetCollection:
        ...
        try:
            ...
            with open(self.storage_path, "r") as f:
                data: CheatSheetCollection = json.load(f)
                return data
    ...
    def list_cheatsheets(self, category: Optional[str] = None) -> list[CheatSheetData]:
    ...
    def get_cheatsheet(self, name: str) -> Optional[CheatSheetData]:
    ...
    def search_cheatsheets(self, query: str) -> list[CheatSheetData]:
        """Search for cheat sheets by name, category, or content."""
        results: list[CheatSheetData] = []
        query = query.lower()
    ...
    def export_cheatsheet(self, name: str, file_path: Optional[str] = None) -> bool:
...
class DisplayFormatter:
    ...
    @staticmethod
    def format_cheatsheet_list(cheatsheets: list[CheatSheetData]) -> str:
    ...
    @staticmethod
    def format_cheatsheet_content(cheatsheet: Optional[CheatSheetData]) -> str:
